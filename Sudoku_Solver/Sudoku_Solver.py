"""
- This is a project that will help solving Sudoku puzzles
...
if __name__ == "__main__":
    print("This is the module for the Sudoku Solver.")
    print("To run the UI, please use the command: streamlit run streamlit.py")
